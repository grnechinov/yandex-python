...
def picture(file_name, width, height, sky_color='#87CEEB',
    ...
    drawer.polygon(((int(0.3 * width), int(height * 0.85)),
                    ...
                    (int(0.8 * width), int(height * 0.65)),
                    (int(0.2 * width), int(height * 0.65)),
                   ...
                   boat_color)
    for i in range(2):
        drawer.triangle((int(0.51 * width), int(0.3 * height)),
                        (int(0.66 * width), int(0.55 * height)),
                        (int(0.51 * width), int(0.4 * height)),
                        sail_color)
    im.save(file_name)
